...
<body>
	...
	<h2>Andmetüüpide olekud</h2>
		...
		<h3>Set</h3>
			<?php echo "Var1 on väärtustatud? " .  isset($var1)?><br>
			<?php echo "Var2 on väärtustatud? " .  isset($var2)?><br>
			<?php echo "Var3 on väärtustatud? " .  isset($var3)?><br>
			<?php echo "Var4 on väärtustatud? " .  isset($var4)?><br>
